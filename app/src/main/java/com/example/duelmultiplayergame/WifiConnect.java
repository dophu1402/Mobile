...
//                            historyPlay.showList();
                            ...
                            int status = checkWinner(tView.getIdX(),tView.getIdY(), 10);
    ...
    private int checkWinner(int currentPosX, int currentPosY, float second)
    {
        int status = 0;
        int check;
        ...
        // Phan dinh thang thua khi het thoi gian
        if (second == 0)
        {
            if (status == 1)
            {
